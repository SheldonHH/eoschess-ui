...
<v-layout v-if="getEndpointConnectionStatus === 0 && getAccountActive && !getAccountLocked && currentMatch" row wrap>
	...
	<tr><td v-for="(item, index) in getRowFromBoard(1,8,true)" v-html="item" @click="highlight($event)" :class="['1-' + index]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(2,16,true)" v-html="item" @click="highlight($event)" :class="['2-' + index]"></td></tr>
  <tr><td v-for="(item, index) in getRowFromBoard(3,24,true)" v-html="item" @click="highlight($event)" :class="['3-' + index]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(4,32,true)" v-html="item" @click="highlight($event)" :class="['4-' + index]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(5,40,true)" v-html="item" @click="highlight($event)" :class="['5-' + index]"></td></tr>
  <tr><td v-for="(item, index) in getRowFromBoard(6,48,true)" v-html="item" @click="highlight($event)" :class="['6-' + index]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(7,56,true)" v-html="item" @click="highlight($event)" :class="['7-' + index]"></td></tr>
  </table>
  ...
  <v-flex xs8 v-else>
  <table id="board" ref="board" v-bind:style="{ height: boardWidth + 'px !important' }">
	<tr><td v-for="(item, index) in getRowFromBoard(7,63)" v-html="item" @click="highlight($event)" :class="['7-' + (index*-1 + 7)]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(6,55)" v-html="item" @click="highlight($event)" :class="['6-' + (index*-1 + 7)]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(5,47)" v-html="item" @click="highlight($event)" :class="['5-' + (index*-1 + 7)]"></td></tr>
  <tr><td v-for="(item, index) in getRowFromBoard(4,39)" v-html="item" @click="highlight($event)" :class="['4-' + (index*-1 + 7)]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(3,31)" v-html="item" @click="highlight($event)" :class="['3-' + (index*-1 + 7)]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(2,23)" v-html="item" @click="highlight($event)" :class="['2-' + (index*-1 + 7)]"></td></tr>
  <tr><td v-for="(item, index) in getRowFromBoard(1,15)" v-html="item" @click="highlight($event)" :class="['1-' + (index*-1 + 7)]"></td></tr>
	<tr><td v-for="(item, index) in getRowFromBoard(0,7)" v-html="item" @click="highlight($event)" :class="['0-' + (index*-1 + 7)]"></td></tr>
  </table>
  <v-btn v-if="!loading" @click="castleMove(1)">Send short castle move</v-btn>
  <v-btn v-if="!loading" @click="castleMove(0)">Send long castle move</v-btn>
    </v-flex>
